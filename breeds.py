...
class ZohoCRMContactCreator:
    ...
    def create_contact_if_not_exists(breed):
        ...
        param_instance.add(SearchRecordsParam.email, breed);
...
def main():
    ...
    if response.status_code == 200:
        ...
        if breeds and "data" in breeds:
            for breed in breeds["data"]:
                if "origin" in breed and breed["origin"] == "Natural":
                    ZohoCRMContactCreator.create_contact_if_not_exists(breed["breed"])
    else:
